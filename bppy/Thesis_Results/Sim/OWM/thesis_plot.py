...
# Create subplots
fig, axs = plt.subplots(2, 2, figsize=(10, 10),gridspec_kw={'hspace': 0})

# Plot the first dataset
axs[0][0].plot(df1['Time'], df1['OWM'],color='r', label='Incremental PID')
...
# axs[0][0].set_xlim(11,15)
axs[0][0].set_ylim(-2,3.8)

# Plot the second dataset
axs[1][0].plot(df2['Time'], df2['OWM'],color='b', label='Feedforward PID')
...
axs[1][0].set_ylim(-1,2.2)
axs[1][0].set_xlim(11,15)
# axs[1][0].set_ylim(-2,3.8)

# # Plot the third dataset
axs[0][1].plot(df3['Time'], df3['OWM'],color='y', label='Linear Differential Sensor System')
# axs[1].text(0.5, 0.95, 'Feedforward PID', horizontalalignment='center', verticalalignment='center', transform=axs[1].transAxes)
axs[0][1].legend(loc='upper right')
axs[0][1].grid(False)
axs[0][1].set_ylim(-1,2.2)
axs[0][1].set_xlim(11,15)
