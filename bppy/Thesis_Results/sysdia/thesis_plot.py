...
# Load the CSV files
max = '/Users/chenxingzhou/Desktop/MT/MT/bppy/Thesis_Results/sysdia/mild.csv'
min = '/Users/chenxingzhou/Desktop/MT/MT/bppy/Thesis_Results/sysdia/bradycardiac.csv'
...
axs[0].plot(df1['Time'], df1['owm'], color='r', label='Mild Exercise')
axs[0].legend(loc='upper right')
axs[0].grid(False)
# axs[0].set_xlim(11.5,13.5)
# axs[0].set_ylim(-1,2)
# axs[0].set_ylim(-1.5,2.75)
# axs[0].set_ylim(-1.5,3.3)
axs[0].set_ylim(-1.8,3.1)
axs[0].set_xlim(12,14.5)

# Plot the second dataset
axs[1].plot(df2['Time'], df2['owm'], color='b', label='Bradycardia')
# axs[1].set_ylabel('Pulse Amplitude/mmHg')
axs[1].legend(loc='upper right')
axs[1].grid(False)
# axs[1].set_xlim(9,15)
# axs[1].set_ylim(-1,2)
# axs[1].set_ylim(-1.5,2.75)
axs[1].set_xlabel("Time/s")
# axs[1].set_ylim(-1.5,3.3)
axs[1].set_ylim(-1.8,3.1)
