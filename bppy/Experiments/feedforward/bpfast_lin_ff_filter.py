...
if __name__== '__main__':   
    ...
    while current_pressure>P_end:                                     # deflation 
        ...
        current_pressure=read(sensor_address,range_min,range_max)
        current_pressure_filtered=single_pole_lpf(current_pressure,current_pressure_filtered,0.2)
        ...
        pulse_filtered=single_pole_lpf(pulse,pulse_filtered,0.3)
        pulse=round(pulse,2)
        # print(delta,',',pulse,",",current_pressure,",",P_ref)
        print(delta,',',pulse,",",pulse_filtered)
