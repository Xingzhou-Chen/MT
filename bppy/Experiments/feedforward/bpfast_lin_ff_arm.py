...
def feedorward(t):
    # ff=26949.7-411.9*t
    # ff=-0.2439*t**3 + 11.39*t**2 - 519.4*t + 2.703e+04
    # ff=-0.1696*t**3 + 5.863*t**2 - 393.5*t + 2.61e+04
    ff=-372.1*t+2.024e+04
    return ff
...
if __name__== '__main__':   
    ...
    while current_pressure>P_end:                                     # deflation 
        current_pressure=read(sensor_address,range_min,range_max)
        # current_pressure_filtered=single_pole_lpf(current_pressure,current_pressure_filtered,0.85)
