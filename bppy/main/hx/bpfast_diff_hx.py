...
i2c_hx = I2C(id=1,scl=Pin(7),sda=Pin(6),freq=400000)
# pump = Pin(16,Pin.OUT)
sensor_b=0x29
sensor_m=0x28
sensor_f=0x30
...
def read_adc_diff():
        data=i2c_hx.readfrom(0x28,3)
        pres=(data[0]<<16)+(data[1]<<8)+data[2]
        # pres=data[0]
        return pres
...
#         
    ...
    # print("max_sampling_rate(difference_hx):Sampling time(s):",delta,"Samples:", count,"Sampling rate: " ,samplingrate )